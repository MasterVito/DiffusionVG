...
def build_position_encoding(args):
    ...
    txt_pos_embed = TrainablePositionalEncoding(max_position_embeddings=args.max_q_l, hidden_size=args.hidden_dim, dropout=args.input_dropout) # text的pe是可学习的，video的是正弦。
